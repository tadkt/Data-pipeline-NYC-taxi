...
CFG_FILE =  os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'config', 'datalake.yaml'))
...
def merge_taxi_zone(df, file):
    ...
    print("Merge data from file: " + file)
...
def transform_data(endpoint_url, access_key, seocret_key):
    """
